<h2><a href="https://leetcode.com/problems/split-array-with-same-average/?envType=problem-list-v2&envId=dynamic-programming">823. Split Array With Same Average</a></h2><h3>Hard</h3><hr><p>You are given an integer array <code>nums</code>.</p>
